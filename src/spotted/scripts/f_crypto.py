...
def parse_args() -> "DecryptArgs":
    ...
    encrypt_parser.add_argument("-k", "--key", required=True, type=str, help="Base64 encoded key")
    ...
    decrypt_parser.add_argument("-k", "--key", required=True, type=str, help="Base64 encoded key")
