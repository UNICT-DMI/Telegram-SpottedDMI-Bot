...
class TelegramApi:
    ...
    def __init__(self, simulator: "TelegramSimulator"):
        ...
        self.__chats[Config.meme_get("group_id")] = Chat(id=Config.meme_get("group_id"), type=Chat.GROUP)
        self.__chats[Config.meme_get("channel_id")] = Chat(id=Config.meme_get("channel_id"), type=Chat.CHANNEL)
        self.__chats[Config.meme_get("channel_group_id")] = Chat(
            id=Config.meme_get("channel_group_id"), type=Chat.GROUP
        )
