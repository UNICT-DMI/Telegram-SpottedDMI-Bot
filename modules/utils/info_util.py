...
class EventInfo():  # pylint: disable=too-many-public-methods
    ...
    def user_name(self) -> str:
        """Name of the user that caused the update. Defaults to None"""
        if self.__query is not None:
    ...
    def inline_keyboard(self) -> InlineKeyboardMarkup:
        """InlineKeyboard attached to the message. Defaults to None"""
        if self.__message is None:
            return None
        return self.__message.reply_markup
    ...
    def forward_from_id(self) -> int:
        """Id of the original message that has been forwarded. Defaults to None"""
        if self.__message is None:
            return None
    ...
    def forward_from_chat_id(self) -> int:
        """Id of the original chat the message has been forwarded from. Defaults to None"""
    ...
    def answer_callback_query(self, text: str = None):
        ...
        Args:
            text: Text to show to the user. Defaults to None.
        """
        try:
    ...
    def edit_inline_keyboard(self, chat_id: int = None, message_id: int = None, new_keyboard: InlineKeyboardMarkup = None):
        ...
        Args:
            chat_id: id of the chat the message to edit belongs to or the current chat if None. Defaults to None.
            message_id: id of the message to edit. It is the current message if left None. Defaults to None.
            new_keyboard: new inline keyboard to assign to the message. Defaults to None.
        """
